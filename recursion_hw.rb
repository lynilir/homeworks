...
# Write a function ice_cream_shop(flavors, favorite) that takes in an array of ice cream
# flavors available at the ice cream shop, as well as the user's favorite ice cream flavor.
